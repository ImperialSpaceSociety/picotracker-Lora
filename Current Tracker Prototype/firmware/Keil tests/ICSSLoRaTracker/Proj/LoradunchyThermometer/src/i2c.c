...
#define DUNCHY_I2C_TIMING_20KHZ        0x505189FF /* Analog Filter ON, Rise Time 400ns, Fall Time 200ns */
...
uint8_t I2C_Loradunchy_Init( void )
{
  if(HAL_I2C_GetState( &I2C_Loradunchy_Handle) == HAL_I2C_STATE_RESET )
  {
    ...
    I2C_Loradunchy_Handle.Init.Timing = DUNCHY_I2C_TIMING_20KHZ;    /* original: 400KHz */
