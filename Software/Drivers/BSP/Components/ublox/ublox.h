...
/* HARDWARE RESET Hot startup, Hardware reset immediately watchdog			no response */
static uint8_t resetReceiver[12]		= {0xB5 ,0x62 ,0x06 ,0x04 ,0x04 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x0E ,0x64};
