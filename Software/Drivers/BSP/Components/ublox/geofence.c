...
{		
		...
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_EU868;
				CURRENT_POLYGON_REGION = EU863870_AFRICA_polygon;
		}
		...
		else if(pointInPolygonF(7, EU863870_PHILIPPINES_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_EU868;
				CURRENT_POLYGON_REGION = EU863870_PHILIPPINES_polygon;
		}

		else if(pointInPolygonF(16, US902928_NAMERICA_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_US915;
				CURRENT_POLYGON_REGION = US902928_NAMERICA_polygon;
		}

		else if(pointInPolygonF(6, AS923925_BRUNEI_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_AS923;
				CURRENT_POLYGON_REGION = AS923925_BRUNEI_polygon;
		}
		...
		else if(pointInPolygonF(7, AS923925_TAIWAN_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_AS923;
				CURRENT_POLYGON_REGION = AS923925_TAIWAN_polygon;
		}
		...
		else if(pointInPolygonF(14, AS923925_INDONESIA_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_AS923;
				CURRENT_POLYGON_REGION = AS923925_INDONESIA_polygon;
		}
		...
		else if(pointInPolygonF(11, AS923925_THAILAND_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_AS923;
				CURRENT_POLYGON_REGION = AS923925_THAILAND_polygon;
		}
		...
		else if(pointInPolygonF(10, US902928_ARGENTINA_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_US915;
				CURRENT_POLYGON_REGION = US902928_ARGENTINA_polygon;
		}

		else if(pointInPolygonF(8, AU915928_BRAZIL_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_AU915;
				CURRENT_POLYGON_REGION = AU915928_BRAZIL_polygon;
		}
		...
		else if(pointInPolygonF(8, AU915928_CHILE_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_AU915;
				CURRENT_POLYGON_REGION = AU915928_CHILE_polygon;
		}

		else if(pointInPolygonF(18, CN779787_CHINA_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_CN779;
				CURRENT_POLYGON_REGION = CN779787_CHINA_polygon;
		}

		else if(pointInPolygonF(8, IN865867_INDIA_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_IN865;
				CURRENT_POLYGON_REGION = IN865867_INDIA_polygon;
		}
		...
		else if(pointInPolygonF(8, AS920923_JAPAN_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_AS923;
				CURRENT_POLYGON_REGION = AS920923_JAPAN_polygon;
		}

		else if(pointInPolygonF(6, KR920923_SKOREA_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_KR920;
				CURRENT_POLYGON_REGION = KR920923_SKOREA_polygon;
		}
		...
		else if(pointInPolygonF(15, AS920923_MALAYSIASG_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_AS923;
				CURRENT_POLYGON_REGION = AS920923_MALAYSIASG_polygon;
		}
		...
		else if(pointInPolygonF(13, AU915928_AUSTRALIA_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_AU915;
				CURRENT_POLYGON_REGION = AU915928_AUSTRALIA_polygon;
		}

		else if(pointInPolygonF(25, RU864870_RUSSIA_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_RU864;
				CURRENT_POLYGON_REGION = RU864870_RUSSIA_polygon;
		}
		...
		else if(pointInPolygonF(38, EU863870_EUROPE_F, latitude, longitude) == 1)
		{
				GEOFENCE_no_tx = 0;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_EU868;
				CURRENT_POLYGON_REGION = EU863870_EUROPE_polygon;
		}
	  ...
	  // Over the sea or areas where there is no frequency declared.
	  else 
		{
				GEOFENCE_no_tx = 1;
				CURRENT_LORA_REGION_SETTINGS = LORAMAC_REGION_EU868;
				CURRENT_POLYGON_REGION = OUTSIDE_polygon;
		}
